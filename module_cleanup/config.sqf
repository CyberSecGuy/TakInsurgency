...
pvpfw_cleanUp_abandonRadius = 3000; // If no unit is closer than the specified distance, the removal countdown will start
...
//////////////////////////////
pvpfw_cleanUp_vehicleRadius = 3000; // Destroyed vehicles cleanup timer will start if no unit is closer than this
...
pvpfw_cleanUp_ruinRadius = 150; // Destroyed Buildings will be deleted if no entity is in the specified range around them
