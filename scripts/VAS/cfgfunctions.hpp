class VAS
{
	...
	class functions
	{
		...
		class accList {};
		class test {};
		class Startview {description = "Dsl gear selection Start view";};
		class Stopview {description = "Dsl gear selection Stop view";};
		class StopviewEsc {description = "Dsl gear selection Stop view when press Esc";};
	};
};